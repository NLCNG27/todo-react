...
export default class App extends React.Component {
  ...
  changeStateData = () => {
    this.setState({
      userName: this.state.userName === "Nguyen" ? "Bob" : "Nguyen"
    })
  }
  ...
  componentDidMount = () => {
    ...
    this.setState(data != null
      ...
      : {
        userName: "Nguyen",
        todoItems: [{ action: "Do homework", done: false },
                    { action: "Grocery shopping", done: false },
                    { action: "Practice programming", done: false }],
        showCompleted: true,
      });
  }
